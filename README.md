...
By default this will build non-root ReVanced with all patches except `amoled` (deprecated in favor of `theme`) and `premium-heading`, they can be configured (or disabled) from the ReVanced settings menu in the app.
