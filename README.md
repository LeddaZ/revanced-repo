...
This will build non-root ReVanced and ReVanced Music with all patches except `premium-heading`, they can be configured (or disabled) from the ReVanced settings menu in the app.
